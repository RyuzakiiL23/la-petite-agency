...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className=" absolute top-10 right-10 h-14 w-14 cursor-pointer transition-all duration-500 hover:bg-white rounded-full border border-[#332E4D] hover:border-white">
          <div className="h-14 w-14 flex items-center text-3xl text-[#332E4D] justify-center">
          <HiXMark />
